...
public class Peliculas  implements java.io.Serializable {
    ...
    public Peliculas(Directores directores, String tituloPelicula, Date fechaPublicacion, int duracion, String paisPublicacion, int tiempoAlquiler, float notaUsuarios, float notaPrensa, boolean esSerie) {
    ...
    public Peliculas(Directores directores, String tituloPelicula, String descripcion, Date fechaPublicacion, int duracion, String paisPublicacion, int tiempoAlquiler, float notaUsuarios, float notaPrensa, boolean esSerie, Series series, Set generoses) {
       this.directores = directores;
       this.tituloPelicula = tituloPelicula;
